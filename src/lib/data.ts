...
export const teachersData = [
  {
    ...
    email: "john@doe.com",
    photo:
      "https://images.pexels.com/photos/1588150/pexels-photo-2888150.jpeg?auto=compress&cs=tinysrgb&w=1200",
    phone: "1234567890",
...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2024, 10, 4, 1, 0), // Octobre est le mois 9 (les mois commencent à 0 en JavaScript)
    end: new Date(2024, 10, 7, 1, 45),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 10, 16, 9, 0), // Le jour suivant
  ...
  // Continuer à mettre à jour les autres événements manuellement
  {
        title: "Math",
         allDay: false,
         start: new Date(2024, 10, 17, 8, 0),
        end: new Date(2024, 10, 17, 8, 45),
      },
       {
        title: "Biology",
        allDay: false,
        start: new Date(2024, 10, 17, 10, 0),
         end: new Date(2024, 10, 17, 10, 45),
      },
    
      {
        ...
        start: new Date(2024, 10, 17, 13, 0),
         end: new Date(2024, 10, 17, 13, 45),
       },
       {
         title: "History",
         allDay: false,
        start: new Date(2024, 10, 17, 14, 0),
        end: new Date(2024, 10, 17, 14, 45),
      },
       {
         title: "English",
         allDay: false,
